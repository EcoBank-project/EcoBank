...
public class SnsController {
	 ...
	 * //검색조회
	 * 
	 * @GetMapping("sns") public String snsSearch(SnsVO snsVO, Model model) {
	 * List<SnsVO> list = snsService.snsList(snsVO);
	 * System.out.println("no찾기"+list); model.addAttribute("snsList",list); return
	 * "sns/snsSearch"; }
	 */
	//단건조회
	@GetMapping("snsInfo")
	...
	public String snsInsertProcess(MultipartFile[] images, 
			                       SnsVO snsVO) {
